...
//                    NavigationLink { LiveConnectView(store: store) } label: {
                    NavigationLink(value: Destination.liveConnect(store)) {
                        FeaturedCard(
...
//                            }
//                        } label: {
                        NavigationLink(value: Destination.sessionPicker2("Race Pace", SessionDestination.racePace)) {
...
//                                .environmentObject(championshipStore)
//                        } label: {
                        NavigationLink(value: Destination.standings(championshipStore)) {
